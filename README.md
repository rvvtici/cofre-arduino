...
<img width="510" height="250" alt="cofre-projeto(1)" src="https://github.com/user-attachments/assets/fdfe689e-4430-4192-b72e-a8513fd837c0" />
...
- Conecte todos os cabos e periféricos de acordo com a [implementação no TinkerCad](#implementação-no-tinkercad)
- Rode e siga as [instruções dos estados](#instruções-dos-estados) abaixo
